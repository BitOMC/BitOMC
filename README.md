...
Bitcoin received will go towards funding maintenance and development of `bitomc`,
...
Alpha `bitomc` wallets are not compatible with wallets created by previous
versions of `bitomc`. To migrate, use `bitomc wallet send` from the old wallet to
send sats and inscriptions to addresses generated by the new wallet with `bitomc
wallet receive`.
...
Take a look at
[this commit](https://github.com/xyz1234567890abc/329f31bf6dac207dad001507dd6f18c87fdef355)
