...
- Add readme
- tweaks to justfile
- Merge pull request #2 from BitOMC/release-0.1.0
- Release 0.1.0
- Merge branch 'release-0.1.0'
- replaced ordinals crate
- Merge pull request #1 from BitOMC/release-0.1.0
...
- Add Rust binary and CI workflow (#1)
- Add readme
- incremented mainnet starting block height
- remove homebrew install instructions
- Merge pull request #3 from BitOMC/release-0.1.0
- resolve unused import error on windows
- resolve unused import error on windows
- Release 0.1.0
- tweaks to justfile
- Merge pull request #2 from BitOMC/release-0.1.0
...
- Add Rust binary and CI workflow (#1)
- Add readme
- get balance without -txindex with multiple wallets loaded
- Merge pull request #4 from BitOMC/release-0.1.1
- removed unused code
- Release 0.1.1
- incremented mainnet starting block height
- remove homebrew install instructions
...
- set first rune height to 855000
- Merge pull request #5 from BitOMC/release-0.1.2
- Release 0.1.2
- get balance without -txindex with multiple wallets loaded
- Merge pull request #4 from BitOMC/release-0.1.1
- removed unused code
...
- Add Rust binary and CI workflow (#1)
- Add readme
- index mint and conversion outpoint txout values so that node may be pruned
- minting bug fix
- updated docs
- updated README
- Merge branch 'master' of https://github.com/BitOMC/BitOMC
- updated README
- Merge pull request #6 from BitOMC/release-0.1.3
- Release 0.1.3
- Merge branch 'release-0.1.2'
- set first rune height to 855000
- Merge pull request #5 from BitOMC/release-0.1.2
